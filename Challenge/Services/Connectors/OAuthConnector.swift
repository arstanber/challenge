...
struct OAuthConfig {
    /// Default callback used by Strava/Whoop/Notion -- the app's custom `challenge://` scheme.
    static let defaultCallbackScheme = "challenge"
    static let defaultRedirectURI = "challenge://oauth-callback"
