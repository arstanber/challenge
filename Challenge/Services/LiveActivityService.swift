...
final class LiveActivityService {
    ...
    typealias Attrs = ChallengeActivityAttributes
    typealias LAState = ChallengeActivityAttributes.ContentState
    typealias LA = ActivityKit.Activity<ChallengeActivityAttributes>
