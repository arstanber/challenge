-- Add the 'suggest-condition' AI feature to the server-side quota table.
-- Re-creates check_and_increment_usage from the 20260612c body (which upgrades
-- a free user with active pro_until to premium limits) and appends the new
-- bucket: free 10 / premium 50 / family 50 / max 150 per month.
